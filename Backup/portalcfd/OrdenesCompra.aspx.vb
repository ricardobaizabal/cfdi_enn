...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ObjCat.Catalogo(cmbProveedor, "select id, razonsocial as nombre from tblMisProveedores order by razonsocial", 0)
            ObjCat.Catalogo(cmbDocumento, "select id, isnull(nombre,'') as nombre from tblTipoDocumento where id=25 order by nombre", 25)
    ...
    Private Sub CargaCFD()
        ...
        Try
            ...
            If rs.Read() Then
                cmbProveedor.SelectedValue = rs("proveedorid")
                proveedorid = rs("proveedorid")
        ...
        Call CargaProveedor(proveedorid)
...
#Region "Combobox Events"
    ...
    Private Sub CargaProveedor(ByVal proveedorid As Long)
        Dim conn As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("conn").ConnectionString)
        Dim cmd As New SqlCommand("EXEC pMisProveedores @cmd=2, @proveedorId='" & proveedorid.ToString & "'", conn)
        ...
        Try
            ...
            If rs.Read() Then
                ...
                ObjData.Catalogo(cmbFormaPago, "select id, nombre from tblFormaPago order by nombre", 0)
...
#Region "Add Invoice Items"
    ...
    Protected Sub GetCFD()
        ...
        Dim conn As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("conn").ConnectionString)
        Dim cmd As New SqlCommand("EXEC pCFD @cmd=54, @proveedorid='" & cmbProveedor.SelectedValue & "'", conn)
...
#Region "Create Invoice"
    ...
    Protected Sub btnCreateInvoice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateInvoice.Click
        If Page.IsValid Then
            ...
            '
            If cmbDocumento.SelectedValue = 25 Then
            ...
            If Timbrado = True Then
                Response.Redirect("~/portalcfd/OrdenesCompraEmitidas.aspx")
            Else
                If cmbDocumento.SelectedValue = 25 Then
                    Response.Redirect("~/portalcfd/OrdenesCompraEmitidas.aspx")
                Else
    ...
    Private Sub ConfiguraReceptor()
        ...
        Dim cmdR As New SqlCommand("exec pCFD @cmd=55, @proveedorid='" & cmbProveedor.SelectedValue.ToString & "'", connR)
        Try
...
#Region "Manejo de PDF"
    ...
    Private Function GeneraPDF(ByVal cfdid As Long) As Telerik.Reporting.Report
        ...
        Select Case tipoid
            Case 3, 6, 7      ' honorarios y arrendamiento
                ...
                Return reporte
            Case Else
                Dim reporte As New Formatos.formato_cfdi33_osdan
                reporte.ReportParameters("plantillaId").Value = plantillaid
                reporte.ReportParameters("cfdiId").Value = cfdid
                Select Case tipoid
                    Case 1, 4, 7
    ...
    Private Function GeneraPDF_Documento(ByVal cfdid As Long) As Telerik.Reporting.Report
        ...
        Dim reporte As New Formatos.formato_ordencompra_osdan
        reporte.ReportParameters("plantillaId").Value = plantillaid
        reporte.ReportParameters("cfdiId").Value = cfdid
...
#End Region
    ...
    Protected Sub txtSearchItem_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearchItem.TextChanged
        ...
        itemsList.Visible = False
        Dim objdata As New DataControl
        gridResults.DataSource = objdata.FillDataSet("exec pCFD @cmd=56, @txtSearch='" & txtSearchItem.Text & "'")
    ...
    Protected Sub cmbProveedor_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbProveedor.SelectedIndexChanged
        Call CargaProveedor(cmbProveedor.SelectedValue)
        Call ClearItems()
    End Sub
