<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="CuentasBeneficiario.aspx.vb" Inherits="LinkiumCFDI.CuentasBeneficiario" %>
                ...
                <tr>
                    <td style="height: 5px">
                        <telerik:RadGrid ID="Cuentaslist" runat="server" AllowPaging="True"
                            ...
                            <MasterTableView AllowMultiColumnSorting="False" DataKeyNames="id" Name="Cuenta" Width="100%">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="rfc" HeaderText="RFC" HeaderStyle-Font-Bold="true" UniqueName="rfc">
                                    </telerik:GridBoundColumn>
