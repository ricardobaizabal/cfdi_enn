...
Partial Public Class CuentasBeneficiario
    ...
    Private Sub EditCuenta(ByVal id As Integer)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("EXEC pCatalogoCuentasBeneficiario @cmd=3, @id=" & id, conn)
    ...
    Private Sub DeleteCuenta(ByVal id As Integer)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("EXEC pCatalogoCuentasBeneficiario @cmd=4, @id=" & id.ToString, conn)
    ...
    Function GetCuenta() As DataSet
        ...
        Dim conn As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("conn").ConnectionString)
        Dim cmd As New SqlDataAdapter("EXEC pCatalogoCuentasBeneficiario @cmd=6", conn)
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If Page.IsValid Then
            ...
            Try
                ...
                Else
                    Dim cmd As New SqlCommand("EXEC pCatalogoCuentasBeneficiario @cmd=5, @banco='" & txtBanco.Text & "', @rfc='" & txtRFC.Text & "', @numctapago='" & txtCuenta.Text & "', @predeterminadoBit='" & chkPredeterminado.Checked & "', @id=" & CuentaID.Value.ToString, conn)
