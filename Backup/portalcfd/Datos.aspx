                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        <td colspan="2" style="width: 66%">
                            ...
                            &nbsp;<asp:Label ID="lblLogoName" runat="server" CssClass="item"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" style="width: 66%">
                            ...
                            &nbsp;<asp:Label ID="lblLogoName2" runat="server" CssClass="item"></asp:Label>
                        </td>
                        <td width="33%">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:Panel Visible="false" runat="server" ID="pnlConfiguracionCorreo">
                                <table width="100%">
                                    <tr>
                                        <td colspan="3">
                                            <br />
