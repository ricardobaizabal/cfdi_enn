                        ...
                        <telerik:RadGrid ID="gridResults" runat="server" Width="100%" ShowStatusBar="True"
                            ...
                            <MasterTableView Width="100%" DataKeyNames="id" Name="Items" AllowMultiColumnSorting="False">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn>
                                        <HeaderTemplate>Cant. a descontar</HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtComentario" TextMode="MultiLine" runat="server" CssClass="box" Width="400px" Height="50px"></asp:TextBox>
                                        </ItemTemplate>
