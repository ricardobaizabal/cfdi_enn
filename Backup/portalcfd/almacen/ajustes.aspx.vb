...
Partial Class portalcfd_almacen_ajustes
    ...
    Private Sub InsertItem(ByVal id As Long, ByVal item As GridItem)
        ...
        ObjData.RunSQLQuery("exec pInventario @cmd=5, @productoid='" + id.ToString + "', @codigo='" + lblCodigo.Text + "', @descripcion='" + lblDescripcion.Text + "', @cantidad='" + txtCantidad.Text + "', @userid='" + Session("userid").ToString + "', @comentario='" + txtComentario.Text + "'")
        ObjData = Nothing
        '
        '
