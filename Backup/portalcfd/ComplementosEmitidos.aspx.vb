...
#Region "Functions"
    ...
    Private Sub DownloadXML(ByVal cfdid As Long)
        ...
        End Try
        '
        Dim FilePath = Server.MapPath("~/portalcfd/cfd_storage/") & serie.ToString & folio.ToString & ".xml"
    ...
    Private Sub DownloadPDF(ByVal cfdid As Long)
        ...
        End Try
        '
        Dim FilePath = Server.MapPath("~/portalcfd/pdf/") & serie.ToString & folio.ToString & ".pdf"
        If File.Exists(FilePath) Then
            Dim FileName As String = Path.GetFileName(FilePath)
            Response.Clear()
            Response.ContentType = "application/octet-stream"
    ...
    Private Sub SendEmail(ByVal cfdid As Long)
        ...
        '   Agrega anexos
        '
        Dim AttachXML As Net.Mail.Attachment = New Net.Mail.Attachment(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml")
        Dim AttachPDF As Net.Mail.Attachment = New Net.Mail.Attachment(Server.MapPath("~/portalcfd/pdf/") & "" & serie.ToString & folio.ToString & ".pdf")
        '
    ...
    Private Sub CancelaCFDI_Aplica(ByVal cfdi As Long, ByVal motivoCancela As String, ByVal folioSustituye As String)
        ...
        Try
            ...
            'Pruebas
            'Dim sifei As New CancelacionPruebasSIFEI33.Cancelacion
    ...
    Private Sub generacbb(ByVal serie As String, ByVal folio As Long)
        ...
        '
        rfcE = GetXmlAttribute(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Rfc", "cfdi:Emisor")
        rfcR = GetXmlAttribute(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Rfc", "cfdi:Receptor")
        total = GetXmlAttribute(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Total", "cfdi:Comprobante")
        UUID = GetXmlAttribute(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "UUID", "tfd:TimbreFiscalDigital")
        sello = GetXmlAttribute(Server.MapPath("~/portalcfd/cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "SelloCFD", "tfd:TimbreFiscalDigital")
...
#End Region
    ...
    Private Sub DatosEmail(ByVal cfdid As Long)
        ...
        '
        '
        mensaje = "Estimado(a) Cliente, por este medio se le anexa el documento de pago solicitado, la cual sirve como comprobante fiscal ante Hacienda." & vbCrLf & vbCrLf & "Gracias por su preferencia." & vbCrLf & vbCrLf
    ...
    Private Sub btnSendEmail_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSendEmail.Click
        ...
        If novalidos = "" Then
            ...
            '   Agrega anexos
            '
            Dim AttachXML As Net.Mail.Attachment = New Net.Mail.Attachment(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml")
            Dim AttachPDF As Net.Mail.Attachment = New Net.Mail.Attachment(Server.MapPath("pdf") & "\" & serie.ToString & folio.ToString & ".pdf")
            '
            objMM.Attachments.Add(AttachXML)
            objMM.Attachments.Add(AttachPDF)
            '
    ...
    Private Sub VerAcuse(ByVal cfdi As Long)
        ...
        '   Obtiene datos del cfdi para construir string del CBB
        '
        rfcE = GetXmlAttribute(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Rfc", "cfdi:Emisor")
        rfcR = GetXmlAttribute(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Rfc", "cfdi:Receptor")
        total = GetXmlAttribute(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "Total", "cfdi:Comprobante")
        UUID = GetXmlAttribute(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "UUID", "tfd:TimbreFiscalDigital")
        sello = GetXmlAttribute(Server.MapPath("cfd_storage") & "\" & serie.ToString & folio.ToString & ".xml", "SelloCFD", "tfd:TimbreFiscalDigital")
        FinalSelloDigitalEmisor = Mid(sello, (Len(sello) - 7))
        '
        Dim totalDec As Decimal = CType(total, Decimal)
        '
    ...
    Private Sub cmbMotivoCancela_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbMotivoCancela.SelectedIndexChanged
    ...
    Private Sub btnCancelaFactura_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancelaFactura.Click
