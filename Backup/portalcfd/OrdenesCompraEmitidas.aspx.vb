...
Partial Public Class OrdenesCompraEmitidas
...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ObjCat.Catalogo(tipoid, "select id, isnull(nombre,'') as nombre from tblTipoDocumento where id=25 order by nombre", 25)
...
#Region "Functions"
    ...
    Private Sub DownloadPDF(ByVal cfdid As Long)
        ...
        Else
            ...
            If tipoid = 10 Or tipoid = 11 Or tipoid = 25 Then
