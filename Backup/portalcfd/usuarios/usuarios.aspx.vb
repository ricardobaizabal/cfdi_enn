    ...
    Private Sub EditUser(ByVal id As Integer)
        ...
        Try
            ...
            If rs.Read Then
                ...
                Dim ObjData As New DataControl
                ObjData.Catalogo(perfilid, "select id, nombre from tblUsuarioPerfil", rs("perfilid"))
                ObjData = Nothing
    ...
    Protected Sub btnSaveUser_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveUser.Click
        ...
        Try
            ...
            If InsertOrUpdate.Value = 0 Then
                ...
                Dim cmd As New SqlCommand("EXEC pUsuarios @cmd=3, @nombre='" & txtNombre.Text & "', @email='" & txtEmail.Text & "', @contrasena='" & txtContrasena.Text & "', @perfilid='" & perfilid.SelectedValue.ToString & "'", conn)
            ...
            Else
                ...
                Dim cmd As New SqlCommand("EXEC pUsuarios @cmd=5, @nombre='" & txtNombre.Text & "', @email='" & txtEmail.Text & "', @contrasena='" & txtContrasena.Text & "', @perfilid='" & perfilid.SelectedValue.ToString & "', @userid='" & UsersID.Value.ToString & "'", conn)
