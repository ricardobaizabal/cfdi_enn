...
Partial Class _Default
        ...
        Try
            ...
            If rs.Read Then
                ...
                Else
                    ...
                    Fecha = GetExpirationDate(rs("certificado"))

                    Session("fechaExpiracionCer") = Fecha.ToString("dd/MM/yyyy")
    ...
    Private Function GetExpirationDate(ByVal archivo As String) As String
        '
        ' Fecha de Vigencia
        '
        '
        ...
        Dim Certificate As String = Server.MapPath("~\portalcfd\certificados\") & archivo

        ' Load the certificate into an X509Certificate object.
        Dim cert As X509Certificate = X509Certificate.CreateFromCertFile(Certificate)

        ' Get the value.
        fecha = cert.GetExpirationDateString()
