...
Partial Class portalcfd_FacturaPDFsinValor
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        'Dim reporte As New Formatos.Factura1
        ...
        'Select Case tipoid
        '    Case 1, 3
        '        reporte.ReportParameters(28).Value = "FACTURA"
        '        reporte.ReportParameters(29).Value = "FACTURADO A"
        '    Case 2
        '        reporte.ReportParameters(28).Value = "NOTA DE CRÉDITO"
        '        reporte.ReportParameters(29).Value = "A FAVOR DE"
        '    Case 4
        '        reporte.ReportParameters(28).Value = "FACTURA EN DÓLARES"
        '        reporte.ReportParameters(29).Value = "FACTURADO A"
        '    Case 5
        '        reporte.ReportParameters(28).Value = "NOTA DE CRÉDITO EN DÓLARES"
        '        reporte.ReportParameters(29).Value = "A FAVOR DE"
        'End Select
        ''
        ''
