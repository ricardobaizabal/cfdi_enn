<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="Unidad.aspx.vb" Inherits="LinkiumCFDI.Unidad" %>
            ...
            <table width="50%" border="0">
                ...
                <tr>
                    <td align="right" style="height: 5px">
                        <asp:Button ID="btnAdd1" runat="server" Text="Agrega Otro Pago" CausesValidation="False" CssClass="item" />
                    </td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                ControlToValidate="claveUnidad" CssClass="item" Text="Requerido" InitialValue="0"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr valign="top">
