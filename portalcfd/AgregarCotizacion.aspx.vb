...
Partial Public Class AgregarCotizacion
...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ObjCat.Catalogo(cmbDocumento, "select id, isnull(nombre,'') as nombre from tblTipoDocumento where id=10 order by nombre", 10)
    ...
    Private Sub CargaCFD()
        ...
        Try
            ...
            If rs.Read() Then
                ...
                If CBool(rs("formatoBit")) Then
                    btnCreateInvoice.Text = "Guardar"
                End If
...
#Region "Create Invoice"
    ...
    Protected Sub btnCreateInvoice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateInvoice.Click
        If Page.IsValid Then
            ...
            If btnCreateInvoice.Text <> "Guardar" Then
                Dim MensageError As String = ""
                RadWindow1.VisibleOnPageLoad = False
                '
                '   Agregado para remisionar
                '
                Call EstableceCotizacionTimbrado()
                Dim cfdid As Long = 0
                cfdid = Session("CFD")
                ...
                End If
            Else
                Call GeneraPDF(Session("CFD"))
            End If

            Session("CFD") = 0
            Response.Redirect("~/portalcfd/Cotizaciones.aspx")
    ...
    Private Sub EstableceCotizacionTimbrado()
        '
        Call CargaTotales()
        '
        ...
        ' Crear un ReportBook para combinar los informes
        Dim reportBook As New Telerik.Reporting.ReportBook()

        ' Agregar los informes al ReportBook
        reportBook.Reports.Add(GeneraPDF_parte1(Session("CFD")))
        reportBook.Reports.Add(GeneraPDF_parte2(Session("CFD")))
        reportBook.Reports.Add(GeneraPDF_images(Session("CFD")))
        reportBook.Reports.Add(GeneraPDF_parte3(Session("CFD")))
        ...
        Dim filePath As String = Server.MapPath("~/") & "link_" & serie.ToString() & folio.ToString() & ".pdf"
...
#End Region
    ...
    Private Sub GeneraPDF(ByVal cfdid As Long)
        Dim serie As String = ""
        Dim folio As Long = 0
        Dim tipoid As Integer = 0
