...
Partial Class portalcfd_Facturar_Ext_Vend
...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ObjCat.Catalogo(userid, "select id, nombre from tblUsuario where isnull(borradoBit,0)=0 order by nombre", 0)
...
#Region "Create Invoice"
    ...
    Private Sub AgregaAddendaAHMSA(ByVal cfdid As Long, ByVal serie As String, ByVal folio As Long)
        ...
        '        Dim reciboitem As String = ""
        '        Dim recepcionLst As New List(Of Object)
        '        Dim listaRecibo As String() = adRecepcion.Text.Split(vbCrLf)
        '        If listaRecibo.Length > 0 Then
        '            For Each reciboitem In listaRecibo
        '                If reciboitem.Length > 0 Then
    ...
    Private Sub AsignaCFDUsuario(ByVal cfdid As Long)
        Dim ObjData As New DataControl
        ObjData.RunSQLQuery("exec pUsuarios @cmd=7, @userid='" & userid.SelectedValue.ToString & "', @cfdid='" & cfdid.ToString & "'")
        ObjData = Nothing
    End Sub
    ...
    Private Function GeneraPDF_PreImpreso(ByVal cfdid As Long) As Telerik.Reporting.Report
        ...
        Select Case tipoid
            Case 3, 6, 7      ' Recibo de honorarios, Factura con retención de IVA
                ...
                Return reporte
            Case Else
                Dim reporte As New Formatos.formato_cfdi_paging_preimpreso
                reporte.ReportParameters("cfdiId").Value = cfdid
                reporte.ReportParameters("plantillaId").Value = 1
                Select Case tipoid
                    Case 1, 4, 11
