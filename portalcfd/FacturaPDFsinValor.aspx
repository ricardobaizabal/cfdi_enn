<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeFile="FacturaPDFsinValor.aspx.vb" Inherits="portalcfd_FacturaPDFsinValor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset>
            <legend style="padding-right: 6px; color: Black">
                <asp:Label ID="lblCFDPDF" runat="server" Font-Bold="true" CssClass="item" Text="CFD Impresión / PDF sin Valor"></asp:Label>
            </legend>
            <table width="100%">
                <tr>
                    <td style="height: 5px">
                ...
                <tr>
                    <td>
                        <telerik:ReportViewer id="ReportViewer1" runat="server" Height="700px" ProgressText="Generando CFD sin valor" ShowParametersButton="False" Width="900px">
