<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="AgregarCotizacion.aspx.vb" Inherits="LinkiumCFDI.AgregarCotizacion" %>
                ...
                <tr>
                    <td>
                        ...
                        <telerik:RadGrid ID="gridResults" runat="server" Width="100%" ShowStatusBar="True"
                            ...
                            <MasterTableView Width="100%" DataKeyNames="id,unitario,unitario2,unitario3,unitario4,defaultprecioid" Name="Items" AllowMultiColumnSorting="False">
                                <Columns>
