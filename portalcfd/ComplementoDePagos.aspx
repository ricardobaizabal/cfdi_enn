<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="ComplementoDePagos.aspx.vb" Inherits="LinkiumCFDI.ComplementoDePagos" %>
    ...
    <asp:Panel ID="panelClients" runat="server">
        <fieldset style="padding: 10px;">
            ...
            <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
                ...
                <tr>
                    <td class="item" style="width: 50%;" colspan="2">
                        <asp:RequiredFieldValidator ID="valClienteID" runat="server" InitialValue="0" CssClass="item" ErrorMessage="Seleccione el cliente al cual le va a facturar." ControlToValidate="cmbCliente" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    </td>
                    <td class="item">
                    ...
                    <td class="item">
                        <asp:RequiredFieldValidator ID="valFecha" runat="server" InitialValue="0" ErrorMessage="Requerido" ControlToValidate="fecha" CssClass="item" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="item" style="width: 25%;">
                ...
                <tr>
                    ...
                    <td class="item" style="width: 25%;">
                        <telerik:RadNumericTextBox ID="txtTipoCambio" runat="server" Width="50%" Type="Currency" NumberFormat-DecimalDigits="6" Value="0"></telerik:RadNumericTextBox>
                    </td>
                    <td class="item">&nbsp;</td>
                    <td class="item">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="item" style="width: 25%;">
                        <asp:RequiredFieldValidator ID="valTipoCambio" runat="server" Enabled="false" ControlToValidate="txtTipoCambio" InitialValue="0" CssClass="item" ErrorMessage="Requerido" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    </td>
                    <td class="item">&nbsp;</td>
                    <td class="item">&nbsp;</td>
                </tr>
    ...
    <asp:Panel ID="panelRecepcionPago" runat="server" Visible="false">
        <fieldset style="padding: 10px;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    <td colspan="2">
                        <telerik:RadTextBox ID="txtRfcBeneficiario" runat="server" Width="95%" >
                        </telerik:RadTextBox>
                    </td>
                    <td>
                        <asp:DropDownList ID="cmbCtaBeneficiario" runat="server" CssClass="box" autopostback="true" Width="95%"></asp:DropDownList>
                    </td>
                    <td width="43%">&nbsp;
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Requerido" ControlToValidate="txtRfcBeneficiario" CssClass="item" SetFocusOnError="true" Enabled="false"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Requerido" ControlToValidate="cmbCtaBeneficiario" CssClass="item" SetFocusOnError="true" Enabled="false" InitialValue="0"></asp:RequiredFieldValidator>
                    </td>
                    <td width="43%"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <telerik:RadTextBox ID="txtRFCCtaOrdenante" runat="server" Width="95%" >
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Requerido" ControlToValidate="txtRFCCtaOrdenante" CssClass="item" SetFocusOnError="true" Enabled="false"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Requerido" ControlToValidate="cmbCtaOrdenante" CssClass="item" SetFocusOnError="true" Enabled="false" InitialValue="0"></asp:RequiredFieldValidator>
                    </td>
                    <td width="43%"></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label9" runat="server" CssClass="item" Font-Bold="True">Numero de Operacion</asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="Label10" runat="server" CssClass="item" Font-Bold="True">Tipo de Pago:</asp:Label>
                    </td>
                    <td width="43%">&nbsp;
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Requerido" ControlToValidate="txtNumOperacion" CssClass="item" SetFocusOnError="true" Enabled="false"></asp:RequiredFieldValidator>
                    </td>
                    <td>&nbsp;
                    </td>
                    <td width="43%">&nbsp;
                                    ...
                                    <telerik:GridTemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox Text='<%# eval("montomxn") %>' ID="txtImportePesos" OnTextChanged="txtMonto_TextChanged" AutoPostBack="true" runat="server" Skin="Default" Width="80px" MinValue="0" Value='0'>
                                                <NumberFormat DecimalDigits="6" GroupSeparator="" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
