<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" CodeBehind="OrdenesCompra.aspx.vb" Inherits="LinkiumCFDI.OrdenesCompra" %>
    ...
    <asp:Panel ID="panelClients" runat="server">
        <fieldset style="padding: 10px;">
            ...
            <table border="0" cellpadding="3" cellspacing="3" align="left" width="100%">
                ...
                <tr>
                    <td class="item" colspan="2">
                        <asp:DropDownList ID="cmbProveedor" runat="server" AutoPostBack="true" CssClass="item"></asp:DropDownList>
                    </td>
                    <td width="25%" class="item">
                ...
                <tr>
                    <td class="item" colspan="2">
                        <asp:RequiredFieldValidator ID="valProveedor" runat="server" InitialValue="0" ErrorMessage="Seleccione el proveedor al cual le va a facturar" ControlToValidate="cmbProveedor" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    </td>
                    <td width="25%" class="item">
