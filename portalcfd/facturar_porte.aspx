<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="facturar_porte.aspx.vb" Inherits="LinkiumCFDI.facturar_porte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
        ...
        <asp:Panel ID="panelSpecificClient" runat="server" Visible="False">
            ...
            <fieldset style="padding:10px;">
                <legend style="padding-right: 6px; color: Black">
                    <asp:Image ID="Image4" runat="server" ImageUrl="~/portalcfd/images/datClient.jpg" ImageAlign="AbsMiddle" />&nbsp;<asp:Label ID="lblOrigenDest" runat="server" Font-Bold="true" CssClass="item" Text="Origen / Destino"></asp:Label>
                </legend>
                ...
                <table width="100%" style="line-height:20px;">
                    <tr>
                        <td class="item">    
                            ...
                            <telerik:RadTextBox ID="txtOrigen" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                        <td class="item">
                            <strong>Destino: </strong><br />
                            <telerik:RadTextBox ID="txtDestino" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                    </tr>
                   <tr>
                        <td class="item">    
                            <strong>Remitente: </strong><br />
                            <telerik:RadTextBox ID="txtRemitente" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                        <td class="item">
                            <strong>Destinatario: </strong><br />
                            <telerik:RadTextBox ID="txtDestinatario" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="item">    
                            <strong>R.F.C. del remitente: </strong><br />
                            <telerik:RadTextBox ID="txtRFCRemitente" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                        <td class="item">
                            <strong>R.F.C. del destinatario: </strong><br />
                            <telerik:RadTextBox ID="txtRFCDestinatario" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="item">    
                            <strong>Domicilio del remitente: </strong><br />
                            <telerik:RadTextBox ID="txtDomicilioRemitente" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                        <td class="item">
                            <strong>Domicilio del destinatario: </strong><br />
                            <telerik:RadTextBox ID="txtDomicilioDestinatario" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="item">    
                            <strong>Se recogerá en: </strong><br />
                            <telerik:RadTextBox ID="txtSeRecogera" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                        <td class="item">
                            <strong>Se entregará en: </strong><br />
                            <telerik:RadTextBox ID="txtEntregara" runat="server" Width="300px"></telerik:RadTextBox>
                        </td>
                    </tr>
                </table>
