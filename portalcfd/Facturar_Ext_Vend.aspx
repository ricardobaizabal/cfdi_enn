<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" Inherits="LinkiumCFDI.portalcfd_Facturar_Ext_Vend" Codebehind="Facturar_Ext_Vend.aspx.vb" %>
                ...
                <table border="0" cellpadding="2" cellspacing="0" align="left" width="95%">
                    ...
                    <tr>
                        <td colspan="4" class="item">
                            <strong>Vendedor: </strong>&nbsp;<asp:RequiredFieldValidator ID="valUserid" runat="server" InitialValue="0" ErrorMessage="Requerido." ControlToValidate="userid" SetFocusOnError="true"></asp:RequiredFieldValidator><br /><br />
                            <asp:DropDownList ID="userid" runat="server"></asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset style="padding:10px;">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td width="33%">
                            <asp:CheckBox ID="chkAddenda" runat="server" CssClass="item" Text="Incluye Addenda AHMSA" AutoPostBack="true" Visible="true" />
                        </td>
                        <td width="33%">
                                ...
                                <table border="0" cellpadding="3" cellspacing="2" align="center" width="100%" style="line-height:20px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="adRecepcion" runat="server" CssClass="box" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                        <td>
