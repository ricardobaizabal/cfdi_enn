...
Partial Public Class actualizar_UUID
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ds = ObjData.FillDataSet("select serie,folio,id from tblcfd where isnull(timbrado,0) =1 and isnull(estatus,0) <>3 and (uuid is null or uuid = '') order by folio")
        ObjData = Nothing
        ...
        For Each row As DataRow In ds.Tables(0).Rows
            ...
            '   Obtiene el UUID
            '
            Dim filePath As String = Server.MapPath("~/portalcfd/cfd_storage/") & "link_" & serie & folio & "_timbrado.xml"
            Dim UUID() As String
            ReDim UUID(0)
            '
